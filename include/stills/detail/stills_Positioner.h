...
/// five members set by hand in fifteen places — `afterSeek()` set all of them, `reopen()` set four
/// and omitted one, `probeFirstFrame()` set three and omitted two, and the rest wrote one each.
