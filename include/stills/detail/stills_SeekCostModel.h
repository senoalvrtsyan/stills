#pragma once
// stills/detail/stills_SeekCostModel.h — what a seek costs and what a frame costs, measured.
//
...
//
// Not thread-safe: a FramePipeline is single-threaded by contract (stills_FramePipeline.h).
