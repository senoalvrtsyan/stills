...
// that decode loop runs (a caller asking which decoder it ended up with, see
// stills_AssetImageGenerator.h), so the snapshot is written under activeMutex and read back under
// it, by value. Nothing else here
