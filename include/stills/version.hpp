#pragma once
// stills/version.hpp — the library's version, for a consumer that has to branch on it.
//
...
#define STILLS_VERSION \
  STILLS_VERSION_AT_LEAST(STILLS_VERSION_MAJOR, STILLS_VERSION_MINOR, STILLS_VERSION_PATCH)

namespace stills {

inline constexpr int version_major = STILLS_VERSION_MAJOR;
inline constexpr int version_minor = STILLS_VERSION_MINOR;
inline constexpr int version_patch = STILLS_VERSION_PATCH;
